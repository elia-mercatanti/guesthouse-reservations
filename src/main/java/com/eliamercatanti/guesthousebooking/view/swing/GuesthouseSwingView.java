...
public class GuesthouseSwingView extends JFrame implements GuesthouseView {
	...
	public GuesthouseSwingView() {
		...
		groupLayout.setHorizontalGroup(
			groupLayout.createParallelGroup(Alignment.LEADING)
				...
				.addGroup(groupLayout.createSequentialGroup()
					.addContainerGap()
					.addComponent(lblErrorLog)
					.addPreferredGap(ComponentPlacement.RELATED)
					.addComponent(lblErrorLogMessage)
		...
		layoutGuestsPanel.setHorizontalGroup(
			layoutGuestsPanel.createParallelGroup(Alignment.LEADING)
							...
							.addGroup(layoutGuestsPanel.createParallelGroup(Alignment.LEADING)
								.addGroup(layoutGuestsPanel.createSequentialGroup()
									...
									.addGroup(layoutGuestsPanel.createParallelGroup(Alignment.LEADING)
										...
										.addComponent(textTelephoneNumber, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)))
								.addComponent(btnAddGuest)
								.addComponent(btnDeleteGuest))
							.addGap(113))))
		);
		layoutGuestsPanel.setVerticalGroup(
			layoutGuestsPanel.createParallelGroup(Alignment.LEADING)
				.addGroup(layoutGuestsPanel.createSequentialGroup()
					.addContainerGap()
		...
		tableGuests.setName("guestsTable");
		guestsScrollPane.setViewportView(tableGuests);
		...
		layoutBookingsPanel.setHorizontalGroup(
			layoutBookingsPanel.createParallelGroup(Alignment.LEADING)
				.addGroup(layoutBookingsPanel.createSequentialGroup()
					.addContainerGap()
					.addGroup(layoutBookingsPanel.createParallelGroup(Alignment.TRAILING)
						...
						.addGroup(Alignment.LEADING, layoutBookingsPanel.createSequentialGroup()
		...
		tableBookings.setName("bookingsTable");
